...
- Automatic chart generation from uploaded audio
- Beat tracking and time‑signature estimation
- Adaptive sectioning with template alignment
- Multi‑lane (4/6/8 keys) and multi‑difficulty modes
- Real‑time feedback with configurable SFX
- Minimal dark UI with custom background logo
...
4. Play with D/F/J/K (or 6/8‑key layouts)

## Limitations

- Browser‑native prototype (no deep stem separation)
- Complex polymeter or abrupt tempo changes may reduce accuracy
